...
class InformationExtractor:
  ...
  def extract_all_informations(self, content):
    self.content = content
    return (self.extract_office_number(), self.extract_process_number(), self.extract_subject(), self.extract_originator())
  ...
  def extract_subject(self):
      pattern = re.compile(r'([0-9]{7}[ ]*[.-][ ]*[0-9]{2}[ ]*[.]*[ ]*[0-9]{4}[ ]*[.]*[ ]*[0-9][ ]*[.]*[ ]*[0-9]{2}[ ]*[.]*[ ]*[0-9]{4})')
      return self.search_pattern(pattern)
  ...
  def extract_originator(self):
      ...
      pattern = re.compile(r'(%s|%s|%s|%s|%s|%s|%s|%s|%s)' % (regex1, regex2, regex3, regex4, regex5, regex6, regex7, regex8, regex9))
